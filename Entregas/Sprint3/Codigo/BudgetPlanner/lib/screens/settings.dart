...
import 'package:budget_planner/widgets/deletar.dart';
...
class _SettingsPageState extends State<SettingsPage> {
      ...
      body: Container(
        ...
        child: ListView(
          children: [
            ...
            buildAccountOptionDelete(context, "Deletar conta"),
  ...
  GestureDetector buildAccountOptionDelete(BuildContext context, String title) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
